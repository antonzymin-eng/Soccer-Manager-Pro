...
- Assembly layer taxonomy (Spec #20 §3.5.2) places 19 of 35 assemblies — ERR-020-002 proposal filed, awaiting owner sign-off (the two August 5 additions, `training-system` and `injuries-medical`, and the August 7 addition, `client-app`, are unplaced like the other 13)
