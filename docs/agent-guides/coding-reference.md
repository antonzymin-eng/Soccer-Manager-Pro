# Coding reference — expanded examples and catalogues
...
> **Purpose:** Expanded examples, catalogues, commands, and deferred-platform detail moved out of `src/CLAUDE.md` on August 27, 2026. Read the compact root and source guides first, then load only the section they route you to.
> **Precedence:** `src/CLAUDE.md` and Spec #20 are authoritative. Where this expanded reference conflicts with either, follow them and update this file rather than carrying a second rule forward.
...
Update this expanded reference when those items are resolved; keep the compact guide free of status narratives.
