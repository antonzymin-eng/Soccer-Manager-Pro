...
|---|---|---|---|
| 0.46 | September 20, 2026 | — | **Owner-held close-chance retirement consequence recorded.** A1c's August 30 evidence remains historical: at that time the non-certifying functional job carried a steady owner-held red and could not safely be required. The September 20 owner decision retires the final held row, removing that specific obstacle without promoting the functional job or changing the six required contexts. Any future required-status promotion remains a separate governance decision with fresh evidence. |
