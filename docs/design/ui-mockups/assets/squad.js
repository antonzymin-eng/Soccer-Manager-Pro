...
const PLAYERS = [
  ...
  { n:22,          pos:'GK', posClass:'pos-gk', name:'T. Heaton',      ca:2.5, pa:2.5, age:38, nat:'ENG', ft:'R', hgt:"6'3\"", second:'—',   fit:99, fitCls:'',     cnd:14, cndCls:'a14', form:'-----', mor:[1,1,1,0,0], morKind:'neu', xg:0.00,xa:0.00,last:null,avg:6.80,apps:2, g:0, a:0, mins:'180',  y:0,val:'£325k',wage:'£40k', exp:2026,rl:'—',    loy:'£500k', agt:'SMP Sports' },
  ...
  { n:37, xi:true, pos:'CM', posClass:'pos-mf', name:'K. Mainoo',      ca:4,   pa:5,   age:19, nat:'ENG', ft:'R', hgt:"5'10\"",second:'AM',  fit:90, fitCls:'',     cnd:20, cndCls:'a20', form:'WWWDW', mor:[1,1,1,1,1], morKind:'pos', xg:3.2, xa:2.8, last:7.6, avg:7.51,apps:26,g:4, a:3, mins:'2,180',y:2,val:'£55m',  wage:'£90k', exp:2029,rl:'£70m', loy:'£1.5m',agt:'SMP Sports', star:true },
