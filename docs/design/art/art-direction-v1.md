...
7. AP-03 technical/font/rights/import proof remains separate and pending. *(Update September 12, 2026: **G2 was accepted by the owner**, recorded in `art-technical-recipe-v1.md` §11a. That closes the source → export → Unity import/GUID/LFS proof. The exact PT Sans Narrow binary, its Reserved-Font-Name handling, the fallback chain, offline packaging and the Ukrainian corpus proof remain AP-03 shipping work.)*
...
| 1.6 | 2026-09-12 | Cross-reference only: §15 item 7 annotation updated for **G2 acceptance** (September 12, 2026). No art-direction decision changed. |
