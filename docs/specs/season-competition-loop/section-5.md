...
**Last Updated:** August 16, 2026 (v0.5 — round-4 reviewed-findings pass over the `ERR-030-046` landing: new **T-SN-DET-005** names the ERR-030-046 within-tier search suite, `AvailabilityCompositionExtremisTests` — the id had been missing since that suite's own creation, the F8 §5-id precedent recurring)
