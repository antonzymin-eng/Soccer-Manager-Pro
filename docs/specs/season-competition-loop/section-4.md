...
├── SeasonSaveConstants.cs        ← existing; SEASON_SAVE_FORMAT_VERSION 1 → 5 across #30 T1 / #29-#41 T1 / D2 / #28 T1 (ERR-030-032 — this line read "1 → 4", one landing stale); + SEASON_STATE_FORMAT_VERSION
