...
**Last Updated:** August 8, 2026 (v1.0 — balance-pass AR pass 11 M1+M2: FR-SN-013's availability seam corrected to LIVE (the §3.4 v1.4 correction had stopped one section short of the FR an implementer reads first), FR-SN-021's signature refreshed three landings forward, + F7/F8 — the composition-pairing and cursor-vs-clock refusals five landings of code had enforced with no normative source)
