...
**Last Updated:** July 22, 2026 (v0.1 — promoted from `docs/tracking/season-competition-loop-design.md` v0.2)
**Version:** 0.1
**Status:** IN REVIEW
...
| Section | Content |
|---|---|
| 1 | Introduction, scope (the playable spine; single-league Stage-2 surface), dependencies, key decisions (KD-1..KD-8), boundary matrix (season loop vs. world vs. match; producer vs. ingest) |
| 2 | Functional requirements (FR-SN-001..034), data structures (`SeasonState`/`Fixture`/`LeagueTableRow`/`SeasonCalendar`/`BoardState`/`MatchResult`), failure modes F1–F6 |
