...
**Last Updated:** August 18, 2026, later still (v2.17 — **ERR-030-047** (adversarial-review round 6, H1,
...
caller re-reading the provider. The choice is a `SeasonState`/config dial, not a
