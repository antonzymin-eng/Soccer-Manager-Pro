...
**Last Updated:** August 17, 2026 (v2.12 — **two OPEN OWNER QUESTIONS in §3.4 CLOSED by owner decision;
...
>   rule makes `m > 12` reachable — the branch is instrumented and locked, so that evidence arrives as a
>   failing test, not as a surprise.
