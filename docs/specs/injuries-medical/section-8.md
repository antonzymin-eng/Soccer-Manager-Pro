...
- **#16 Deterministic Sim** — `CanonicalSerializer`; `DeterministicRngService`; the
  `DOMAIN_TAG_INJURIES_MEDICAL = 0x2A` / `SubsystemOrdinals.InjuriesMedical = 92` off-pitch allocation
  (ERR-041-001). `docs/specs/deterministic-sim/section-3.md`.
