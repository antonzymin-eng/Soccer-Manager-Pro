...
**Last Updated:** August 23, 2026 (v0.4 — Group-B AR findings, `fr-md-count-claims-stale`: the §2 row's FR
count "FR-MD-001..027" was stale since ERR-041-020 appended FR-MD-025a on August 22 — corrected to
"FR-MD-001..027 + FR-MD-025a (28 unique; deliberately non-contiguous)")
**Last Updated (prior):** August 8, 2026 (v0.3 — balance-pass AR pass 10 L3: the §2 row's failure-mode range F1..F7 → F1..F8, stale since pass 9 added F8)
...
| 2 | Functional requirements FR-MD-001..027 + FR-MD-025a (28 unique; deliberately non-contiguous — see section 2 v0.11), data structures, failure modes F1..F8 |
...
| 0.4 | 2026-08-23 | — | **Group-B AR findings (`fr-md-count-claims-stale`)**: the §2 row's FR count corrected from "FR-MD-001..027" to "FR-MD-001..027 + FR-MD-025a (28 unique; deliberately non-contiguous)" — stale since ERR-041-020 appended FR-MD-025a on August 22. |
#endregion
