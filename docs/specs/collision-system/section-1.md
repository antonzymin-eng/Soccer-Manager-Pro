...
| Goalkeeper diving/punching collision | Goalkeeper Mechanics (#11) | Stage 0 treats goalkeeper as normal agent with `IsGoalkeeper` flag; Spec #10 defines diving/punching special cases |
| Aerial collision (heading duels) | Heading Mechanics (#10) | Spec #9 defines aerial duel logic; Collision System provides ground-only detection in Stage 0 |
