...
| **G2** — back-props filed at approval (`ERR-048-001`, `ERR-038-004`) | **OPEN** — lands atomically with the flip to `APPROVED` |
...
**Status: `IN REVIEW`.** G1 is closed. **G2, G3 and G4 remain open**, and G3 cannot be closed by the
