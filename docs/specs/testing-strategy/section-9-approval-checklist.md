...
| 9.1.14 | All appendices A … F present | `docs/specs/testing-strategy/appendices.md` | [x] |
...
| 9.3.2 | Lead-developer sign-off captured | PR approval signature | [x] |
| 9.3.3 | `spec-error-log.md` updated with any cross-spec drift discovered during drafting | `docs/tracking/spec-error-log.md` | [x] |
| 9.3.4 | `SPEC_INDEX.md` status updated atomically with sign-off | `docs/specs/SPEC_INDEX.md` row 19 | [x] |
