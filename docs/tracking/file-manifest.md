...
| 20 | `docs/specs/code-standards/` | DRAFT — adversarial review pass-1 applied May 11, 2026 (10 section files + appendices drafted; awaiting lead-developer R-01..R-05 sign-off before IN REVIEW) |
...
- Code Standards (#20) outline-tier files: `outline.md` (high-level v1.0), `outline-mid.md` (mid-level v1.3), `outline-detailed.md` (detailed v1.3). Section files authored from the detailed outline May 7–8, 2026; adversarial review pass-1 applied May 11, 2026. Current set: `section-1.md` v1.0.1, `section-2.md` v1.0.1, `section-3.md` v1.0.1, `section-4.md` v1.0, `section-5.md` v1.0.1, `section-6.md` v1.0.1, `section-7.md` v1.0.1, `section-8.md` v1.0, `section-9-approval-checklist.md` v1.0.1, `appendices.md` v1.1. SPEC_INDEX.md transition to IN REVIEW pending lead-developer R-05 sign-off.
