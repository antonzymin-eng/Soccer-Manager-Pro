...
| `src/match-engine/tests/MatchEngineSnapshotSchemaTests.cs` | Phase B step B3: SNAPSHOT_SCHEMA_VERSION pin (2 as of C5); OscillationGuard-state + ball-spin digest-preimage probes; locked-guard same-seed determinism |
