...
| `docs/tracking/league-bootstrap-design.md` | Design supplement (**v1.6, Aug 17, 2026** — **A3 LANDED; A4a RAN Aug 12, 2026; KD-7a HELD**) — the league bootstrap (club identity/naming, strength distribution, world-seed derivation) plus the roadmap-A4a round-resolution model shape and calibration methodology. Closes §6 item 1 of the path-to-playable roadmap; explicitly not #47 (no editor, no new data format) |
