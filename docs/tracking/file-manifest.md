...
| 15 | `docs/specs/attacking-ai/` | NOT STARTED — `outline-detailed.md` v1.1 authored May 17, 2026; adversarial review (`adversarial-review-outline-detailed-v1.md`) filed and all 9 findings (3H/3M/3L) resolved same day; section files are stubs only |
