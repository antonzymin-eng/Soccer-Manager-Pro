...
| 14 | `docs/specs/defensive-ai/` | NOT STARTED (outline-detailed.md v1.0 added May 17, 2026) — detailed outline resolves all 14 adversarial findings (6 H / 6 M / 2 L) from May 6, 2026 review; 19 KDs; 37 FRs; stage-binding Stage 0 spec / Stage 1 runtime; ERR-014-001..004 pre-filed; DOMAIN_TAG_DEFENSIVE_AI = 0x1A [CROSS-PENDING]. Section files remain stubs. |
