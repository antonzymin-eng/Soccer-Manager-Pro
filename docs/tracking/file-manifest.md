...
- Code Standards (#20) outline-tier files: `outline.md` v1.1, `outline-mid.md` v1.4, `outline-detailed.md` v1.4. Current A3 amendment set: `section-1.md` v1.1, `section-2.md` v1.8, `section-3.md` v1.12, `section-4.md` v1.4, `section-5.md` v1.5, `section-6.md` v1.2, `section-7.md` v1.3, `section-8.md` v1.3, `section-9-approval-checklist.md` v1.2, `appendices.md` v1.6.3. The amended surfaces are **AMENDMENT DRAFT**; the May 11, 2026 approved baseline remains operative and `SPEC_INDEX.md` intentionally stays at APPROVED until A3.4 performs the atomic reapproval/status synchronization.
