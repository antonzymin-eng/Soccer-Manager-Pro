...
- Testing Strategy (#19) files: `outline.md` v1.1, `outline-detailed.md` v1.2, `section-1.md` v0.3, `section-2.md` v0.3, `section-3.md` v0.4, `section-4.md` v0.3, `section-5.md` v0.3, `section-6.md` v0.3, `section-7.md` v0.3, `section-8.md` v0.3, `section-9-approval-checklist.md` v1.0.3, and `appendices.md` v0.4. The May 15, 2026 baseline is APPROVED and remains operative; the A3.2a/A3.2b surfaces are **AMENDMENT DRAFT** pending A3.4 coordinated #19/#20 reapproval. A3.2a expands the catalogue to 97 FRs and adds §3.11/Appendix G proof semantics; A3.2b synchronizes §1/§4–§9, both outlines, FR-to-verification coverage, four-gate topology, Governance/#20 boundaries, exception limits, negative fixtures, and tracking. `SPEC_INDEX.md` is intentionally unchanged and no architecture/evidence merge gate is activated before A8.
