...
| 18 | `docs/specs/performance-optimization/` | IN PROGRESS (May 13, 2026) — `outline.md` v1.0 + `outline-detailed.md` v1.1 (KD-3 inverted; ERR-018-001 resolved); section files still stubs |
