...
**Last Updated:** August 22, 2026 — **`ERR-016-009`'s `buildHash` half CLOSED (spec + code, same commit), and the six long `CLAUDE.md` landing narratives moved verbatim to a new `landing-history.md`.**
