...
| 14 | `docs/specs/defensive-ai/` | IN REVIEW (May 17, 2026) — section files v0.2 (section-1.md through section-9-approval-checklist.md + appendices.md + adversarial-review-section-files-v1.md); PASS-1 adversarial review (17 findings: 6 H / 7 M / 4 L) filed and all resolved in v0.2 fix pass same day; ERR-014-001..004 pre-filed; DOMAIN_TAG_DEFENSIVE_AI = 0x1A [CROSS-PENDING]. Outstanding: ERR-014-001 (#8 §2.2.6 ratification), #12 APPROVED gate, ERR-014-002/003 Stage 1 channels, ERR-014-004 #16 §3.4 tag, lead-developer R-01..R-05. |
| 15 | `docs/specs/attacking-ai/` | IN REVIEW (May 18, 2026) — section files v0.2 (section-1.md through section-9-approval-checklist.md + appendices.md); PASS-1 adversarial review (7 findings: 1 H / 5 M / 1 L) filed and all resolved in v0.2 fix pass May 18, 2026; ERR-015-001..005 pre-filed; DOMAIN_TAG_ATTACKING_AI = 0x1B [CROSS-PENDING]. Outstanding: ERR-015-001 (#16 §3.4 domain-tag), ERR-015-002 (#8 §2.2.6 ratification), ERR-015-005 (#8 §1.3.2 one-token patch), #12 APPROVED gate, ERR-015-003/004 Stage 1 channels (non-blocking), lead-developer R-01..R-05. |
...
**Notes:**
- Attacking AI (#15) files (May 17, 2026): `outline.md` (high-level v1.0 with embedded adversarial review), `outline-detailed.md` (v1.1 — adversarial-review-outline-detailed-v1.md filed and all 9 findings 3H/3M/3L resolved same day), `adversarial-review-outline-detailed-v1.md`, and stub section files (`section-1.md` through `section-9-approval-checklist.md` + `appendices.md` — all empty scaffolds, not yet authored). `DOMAIN_TAG_ATTACKING_AI = 0x1B [CROSS-PENDING]`; ERR-015-001..005 pre-filed. 36 FRs enumerated. Status NOT STARTED (section files must be authored and PASS-1 reviewed before status advances to IN REVIEW).
