...
| **B9** | **Unity client P5** — the UGUI shell: Main Menu, Tactics Setup, Match View (stats panel, speed controls, in-match tactical buttons onto the P2 command queue), Post-Match Report. **Budget a cert-host run for this landing.** | §5-P5 | **host** |
