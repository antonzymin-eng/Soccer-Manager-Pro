...
> **Last Updated:** September 9, 2026 — **The localization execution plan reaches `main` on PR #382 as v2.3, closing the discoverability gap the L3A landing recorded but could not close. The `<L3A_MERGE_COMMIT>` placeholder is resolved. Documentation only; a stray header label from the PR #370 close-out is repaired.**
...
> **What is still open.** This lands a plan, not an implementation. L0R (PR #372) and then L1 are the next slices; L3B's dependency `L2 + merged L3A` is now half-satisfied. Where this plan and APPROVED #49 differ, the spec wins.
>
