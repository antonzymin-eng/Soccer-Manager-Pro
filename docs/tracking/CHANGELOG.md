...
> (`foul-discipline-balance-design.md` **v1.1** *(since v1.3)*, new §7 item **2a** *(renumbered to item **3** at v1.2 — `2a.` is not a valid list marker)*). That note's own item 2 said
...
> green throughout.
>
> **`match-engine-wiring-backlog.md` **v1.10** *(since v1.24)* records the consequence none of these three holds could
...
> re-pointed: `match-engine-wiring-backlog.md` is at **v1.11** *(since v1.24)*, whose §5 note carries the corrected
