...
> Supporting evidence was added before this archive lands: the uncited pre-W6 six-seed arm (`35815667045`, measured `f69aaef0…`) is retained from artifact `10732311509` with the API digest verified, byte-exact report/TSV/JSON/runsettings, and a losslessly retained TRX whose original hash is pinned; the artifact API expiry is `2026-12-22T03:46:31Z`. A separate transcribed supporting file preserves the result semantics of the W6 pre-fix discriminator (`39.75` expected vs `40.0` observed), the 5/0 focused W6 post-fix proof, and the 2/0 SeasonSave focused proof. This does not change the 15-run PR #439 citation ledger, authorize ref deletion, or make a W3-vs-W6 attribution claim.
>
>
