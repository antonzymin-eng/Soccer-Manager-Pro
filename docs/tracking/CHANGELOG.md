...
> **Last Updated:** September 4, 2026, later still — **`ERR-019-003`: the `ERR-019-002` fix published a reached, unmet Stage 0+1 MUST as half-satisfied. Found by the Codex review bot on PR #358 (P1), not by the pass that wrote the row. Documentation only.**
