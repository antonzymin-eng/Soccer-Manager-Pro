...
> **Last Updated:** September 4, 2026, latest — **The `System XI` rename landed (PR #359): 94 files, +140/−138, audited behaviour-safe. Its spec version-history obligation is NOT discharged, and is filed as an owner decision rather than papered over.**
