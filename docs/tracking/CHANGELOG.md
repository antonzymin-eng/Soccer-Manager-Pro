...
> **Last Updated:** September 4, 2026, late — **Residual from the same external review: the duplicate-claim path was still exiting 0, and one comment still used the retired metric name. Tooling and documentation only.**
