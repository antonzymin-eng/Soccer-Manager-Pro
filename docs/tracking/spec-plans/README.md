...
| 4 | 31 | [Transfers, Contracts & Negotiation](spec-31-transfers-contracts-negotiation.md) | FR-TX | `0x23` / 85 |
...
| 6 | 35 | [Media & Press Interactions](spec-35-media-press-interactions.md) | FR-ME | `0x27` / 89 |
...
| 8 | 49 | [Localization & Accessibility](spec-49-localization-accessibility.md) | FR-LC | presentation — none |
