...
| v0.3 | July 24, 2026 | Amendment-01 boundary recorded in §1: the game-wide audio playback framework (mixer/buses/catalogue/settings) is #51; #48 keeps event→cue mapping only, with the Wave-7 direct-playback/stub-bus option and #51's playback-side rehoming per spec-51 KD-1. |
