...
> **Last Updated:** September 26, 2026 (v2.12 — W8 B review closure follow-up: 295<355<360 is first-attempt-only, retained-possession retries are live-budget-gated, LongKick target arrival is measured rather than assumed, and #5/#11 approval gates are explicit. No production code in this revision.)
