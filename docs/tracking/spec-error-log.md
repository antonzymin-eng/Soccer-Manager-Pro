...
**What this does NOT close.** The §5.Z.15 lever is discharged and the goal rate moved only 15.3 → 14.0
per match. The residual is the shot side, recorded in the owner document §7 and not fixed here: shots
