...
**Version:** 1.27
**Updated:** June 11, 2026 (ERR-008-002 through ERR-008-011 filed from the Decision Tree #8 comprehensive audit (spec + May 29 implementation); all ten spec-side defects patched and CLOSED same commit — see the consolidated entry below and `decision-tree/audit-report.md`)
...
*End of Spec Error Log v1.27 — June 12, 2026.*
