...
change is the point of the fix. Locked by 9 `OptionGeneratorTests` (v1.7): the P5 pivot on the
...
old and new models, run over all nine, confirms **5 of the 8 evaluable against the old model FAIL on
