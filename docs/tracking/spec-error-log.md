...
**RECORDED, not fixed — a third defect on the same surface.** Nothing in the §4.2.2 lifecycle
recomputes `currentSnapshotDigest` from the payload it just read: step 4 validates the chain LINK
