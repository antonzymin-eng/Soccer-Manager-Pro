...
> **Last Updated:** September 21, 2026 (v0.5 — PR #407 closeout / ERR-031-001 and ERR-031-002; section files remain authoritative).
> **Last Updated (prior):** September 14, 2026 (v0.4 — #31 T0 implementation / C6 finding close-out; section files remain authoritative).
...
| v0.5 | September 21, 2026 | PR #407 closeout: `ERR-031-001` repairs the APPROVED KD-1/G4 residue that still called positional need deep-only; `ERR-031-002` repairs §3.3's affordability/staged-finance order and lands the matching runtime regression. The section files remain authoritative. |
