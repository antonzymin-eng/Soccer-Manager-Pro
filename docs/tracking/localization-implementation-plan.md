...
| M2 — no ERR ids | **Accepted** | The original review identified two #49 defects (proposed ERR-049-002/003); v2.4 subsequently added proposed ERR-049-004/005. All four are recorded before implementation after re-verifying the ids are free at filing, and discharged atomically with their implementing commits. |
