...
// Created:  2026-06-19
// Modified: 2026-09-17 (ERR-006-005 FM-03 contact-time possession-loss lock)
// Modified: 2026-06-19
// Author:   —
...
namespace TacticalDirector.ShotMechanics.Tests
{
    ...
    public sealed class ShotExecutorStateTests
    {
        ...
        public void FM03_ContactTimePossessionLoss_CancelsWithoutErrorOrKick()
        {
            ...
            var ball = BallState.CreateAtPosition(new Vector3(85f, 34f, BallPhysicsConstants.Ball.RADIUS));
            ...
            Assert.AreEqual(ContactState, executor.CaptureState().State, "executor must reach CONTACT");
...
// | 1.2     | 2026-09-17 | —      | ERR-006-005: CONTACT-time possession loss logs Warning, cancels, and never kicks. |
