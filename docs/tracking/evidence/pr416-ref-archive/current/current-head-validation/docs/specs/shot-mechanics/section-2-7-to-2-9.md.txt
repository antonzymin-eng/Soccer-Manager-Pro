...
| FM-06 | Tackle-interrupt flag observed after executor has entered CONTACT | State machine CONTACT frame | Ignore the flag itself; do not retroactively run the WINDUP interrupt path | If authoritative possession has actually been lost before `ApplyKick()`, §4.2.4 FM-03 governs: cancel with no kick. Otherwise the shot proceeds. ERR-006-005. |
...
| 1.2 | September 17, 2026 | Claude (AI) / Anton | ERR-006-005: FM-06 now distinguishes an ignored CONTACT-phase interrupt flag from actual CONTACT-time possession loss; the latter is cancelled by the §4.2.4 safety re-check before ApplyKick. |
