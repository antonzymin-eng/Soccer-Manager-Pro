...
| Reserved (5) | Tackling, Marking, Concentration, Teamwork, FirstTouchAbility — master plan §4.2 attributes not yet consumed by any Stage-0 spec; declared for forward compatibility, same pattern as `DtAgentAttributes.Crossing` |
