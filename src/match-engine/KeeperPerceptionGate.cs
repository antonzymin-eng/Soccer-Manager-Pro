...
namespace TacticalDirector.MatchEngine
{
    ...
    {
        /// <summary>
        /// Returns true only when the existing save-flight predicate is armed and no agent body — from
        /// either team — screens the ball from the keeper. Pure and allocation-free.
        /// </summary>
