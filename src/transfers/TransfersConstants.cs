...
//           Spec #31 Appendix A, §3.1, §3.5 (transfer constants)
...
namespace TacticalDirector.Transfers
{
    ...
    public static class TransfersConstants
    {
        ...
        /// <summary>[FIXED] Identity multiplier for deferred club-need/personality/staff modulation. Spec #31 Appendix A.</summary>
