...
namespace TacticalDirector.HeadingMechanics
{
    ...
    /// Replaces the Stage 0 no-op. Heading Mechanics #10 §4.3.
    /// </summary>
...
// | 1.1     | 2026-05-28 | —      | AR-1 H-4: removed Debug.Log (allocates on hot path FR-CS-031).           |
// | 1.2     | 2026-05-28 | —      | AR-3 L-1: corrected stale XML doc.                                       |
// | 1.3     | 2026-05-30 | —      | Stage 1: replaced no-op with three-tier forwarding to EventBus.          |
// | 1.4     | 2026-06-12 | —      | ERR-017-002: three constraint-only Publish overloads (CS0111 -           |
// |         |            |        | constraints are not part of a method signature; never compiled) merged   |
// |         |            |        | into one where T : struct forwarder; tier routing now resolved inside    |
// |         |            |        | EventBus via cached marker dispatch. Call sites unchanged.               |
#endregion
