...
namespace TacticalDirector.InjuriesMedical
{
    ...
    /// </para>
    /// <para>
    /// <b>Player order is not state.</b> The block is a map keyed by player id (FR-MD-018), so the codec
    /// canonicalizes to ascending player id on encode; this type imposes no order of its own. What
    /// round-trips field-identically is each player's <see cref="InjuryState"/>, keyed by his id.
    /// </para>
    /// </summary>
