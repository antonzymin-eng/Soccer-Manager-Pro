...
namespace TacticalDirector.SeasonSave
{
    ...
    public static class SeasonSaveCodec
    {
            ...
            byte[] matchBlobOrNull)
        {
            ...
            byte[] disciplineBlob = discipline.Bytes;
            if (disciplineBlob == null)
            {
...
// | 1.7     | 2026-08-13 | —      | #44 T1 (roadmap C1): the frame gains the mandatory #44           |
// |         |            |        | discipline sub-blob between the progression block and the        |
