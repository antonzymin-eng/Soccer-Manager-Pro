...
namespace TacticalDirector.TestingStrategy
{
    ...
    public static class TestingStrategyConstants
    {
        ...
        /// </summary>
        public static readonly float UnitPyramidFloorFraction = Config.GetFloat("testing-strategy", "UnitPyramidFloorFraction", 0.60f);
        ...
        /// </summary>
        public static readonly float IntegrationPyramidCeilingFraction = Config.GetFloat("testing-strategy", "IntegrationPyramidCeilingFraction", 0.25f);

        /// <summary>
        /// [GT] Simulation-tier maximum fraction of total test count (0.12 = 12%).
        /// Ceiling in the pyramid contract per §3.1.2. Stage-gated per KD-5.
        /// </summary>
        public static readonly float SimulationPyramidCeilingFraction = Config.GetFloat("testing-strategy", "SimulationPyramidCeilingFraction", 0.12f);

        /// <summary>
        /// [GT] End-to-end / soak-tier maximum fraction of total test count (0.03 = 3%).
        /// Ceiling in the pyramid contract per §3.1.2. Stage-gated per KD-5.
        /// </summary>
        public static readonly float EndToEndPyramidCeilingFraction = Config.GetFloat("testing-strategy", "EndToEndPyramidCeilingFraction", 0.03f);

        /// <summary>
        /// [GT] Tier A authoritative-hard line coverage minimum (0.98 = 98%).
        /// Per KD-9 / §3.6.2 / FR-TS-053. Stage-gated per KD-5.
        /// </summary>
        public static readonly float TierALineCoverageMin = Config.GetFloat("testing-strategy", "TierALineCoverageMin", 0.98f);

        /// <summary>
        /// [GT] Tier A authoritative-hard branch coverage minimum (0.95 = 95%).
        /// Per KD-9 / §3.6.2 / FR-TS-053. Stage-gated per KD-5.
        /// </summary>
        public static readonly float TierABranchCoverageMin = Config.GetFloat("testing-strategy", "TierABranchCoverageMin", 0.95f);

        /// <summary>
        /// [GT] Tier B bounded-authoritative line coverage minimum (0.90 = 90%).
        /// Per KD-9 / §3.6.2 / FR-TS-054. Stage-gated per KD-5.
        /// </summary>
        public static readonly float TierBLineCoverageMin = Config.GetFloat("testing-strategy", "TierBLineCoverageMin", 0.90f);

        /// <summary>
        /// [GT] Tier B bounded-authoritative branch coverage minimum (0.80 = 80%).
        /// Per KD-9 / §3.6.2 / FR-TS-054. Stage-gated per KD-5.
        /// </summary>
        public static readonly float TierBBranchCoverageMin = Config.GetFloat("testing-strategy", "TierBBranchCoverageMin", 0.80f);
        ...
        /// </summary>
        public static readonly float UnitWallTimeBoundMs = Config.GetFloat("testing-strategy", "UnitWallTimeBoundMs", 1.0f);

        /// <summary>
        /// [GT] Pre-commit pipeline wall-time budget in seconds (60 s).
        /// Local-feedback budget per §4.5.1 / §3.10. Stage-gated per KD-5.
        /// </summary>
        public static readonly float PreCommitWallTimeBoundSeconds = Config.GetFloat("testing-strategy", "PreCommitWallTimeBoundSeconds", 60.0f);
        ...
        /// </summary>
        public static readonly int QuarantineExpiryDays = Config.GetInt("testing-strategy", "QuarantineExpiryDays", 14);
        ...
        /// </summary>
        public static readonly int EvictionQuarantineCount = Config.GetInt("testing-strategy", "EvictionQuarantineCount", 3);

        /// <summary>
        /// [GT] Eviction observation window in days (90 days = one calendar quarter).
        /// §3.7.4 / FR-TS-065. Stage-gated per KD-5 (§3.7 preamble).
        /// </summary>
        public static readonly int EvictionWindowDays = Config.GetInt("testing-strategy", "EvictionWindowDays", 90);
        #endregion
    }
}
