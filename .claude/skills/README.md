...
|---|---|---|
| `match-realism-pass` | **wiring gate** → measure → localize → fix → calibrate *(only if the gate passed)* → re-measure → lock | 7 passes (§5.Z.17–§5.Z.23) in ~2 weeks; 3 of the chain (§5.Z.15, .16, .23) were wiring, not calibration |
