...
INSTRUMENTS = {
    ...
    "match-balance-scoreline": Instrument(
        ...
        "src/match-engine/tests/match-engine-tests.gen.csproj",
        "FullyQualifiedName~ScorelineBalanceDiagnostic",
        "=== §5.Z.4 scoreline W/D/L + decision-tree shape census ===",
    ),
    "match-balance-contact": Instrument(
        ...
        "src/match-engine/tests/MatchBalanceDiagnosticTests.cs",
        "src/match-engine/tests/match-engine-tests.gen.csproj",
        "FullyQualifiedName~ContactStreamDiagnostic",
        "=== §5.Z.13 contact-stream measurement — FULL-MATCH primary sample ===",
    ),
    "engine-scoring": Instrument(
        ...
        "=== ENGINE SCORING DIAGNOSTIC (ERR-025-005) ===",
    ),
}
