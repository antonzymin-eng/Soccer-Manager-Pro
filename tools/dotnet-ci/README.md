...
|---|---|---|---|
| Governance addendum | 2026-09-23 | — | Adds the PR #439 evidence-ref archival verifier: 16-ref exact-head topology, 39 branch-exclusive blob states, 26 PR-cited Actions runs, GitHub-API citation/metadata verification, and an explicit no-delete-until-authorized boundary. |
